...
mod paths {
    ...
    lazy_static! {
        pub static ref GLOBAL_REGEX_SET: regex::RegexSet = regex::RegexSet::new(&[
            r"^/javabr/MFT/1.0.0/jobs/transfers$"
        ]).unwrap();
    }
    pub static ID_JOBS_TRANSFERS: usize = 0;
}
    ...
    C: Has<XSpanIdString>  + 'static
{
    ...
    fn call(&self, (req, mut context): Self::Request) -> Self::Future {
        ...
        match &method {
            ...
            // InitiateTransfer - POST /jobs/transfers
            &hyper::Method::Post if path.matched(paths::ID_JOBS_TRANSFERS) => {
                    ...
                    .then(move |result| -> Box<Future<Item=Response, Error=Error>> {
                        match result {
                            Ok(body) => {
                                ...
                                let param_transfer_job_command: Option<models::TransferJobCommand> = if !body.is_empty() {
                                    ...
                                    match serde_ignored::deserialize(deserializer, |path| {
                                        ...
                                        Ok(param_transfer_job_command) => param_transfer_job_command,
                                ...
                                Box::new(api_impl.initiate_transfer(param_transfer_job_command, &context)
                                    .then(move |result| {
                            ...
                            Err(e) => Box::new(future::ok(Response::new().with_status(StatusCode::BadRequest).with_body(format!("Couldn't read body parameter TransferJobCommand: {}", e)))),
                        }
                    })
